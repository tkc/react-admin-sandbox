...
class Settings extends React.Component {
  ...
  render() {
    ...
    return (
      <div className={isSettingsOpen ? `${styles.settings} ${styles.settingsOpened}` : styles.settings}>
        <Scrollbars style={{ height: "100vh" }}>
          <div className={styles.container}>
            <div className={styles.title}>
              Theme Settings
              <button className={`${styles.close} fa fa-times`} onClick={this.closeSettings} type="button" />
            </div>
            <div className={styles.description}>
              This component &quot;Settings&quot; gives possibility to construct custom blocks with any widgets,
